...
export const BADGE_RULES = [
  ...
  { id: 'golden_carrot', label: 'The Golden Carrot', description: 'Unlocked the carrot theme with the legendary code', icon: '🥕',    check: (stats) => stats.konamiUnlocked },
      ...
      ['basic', 'intermediate', 'expert'].forEach(level => {
        ...
        if (totalCount > 0 && completedCount >= totalCount) {
          grads.push({
            ...
            label: `${lang.label} ${level.charAt(0).toUpperCase() + level.slice(1)} Grad`,
